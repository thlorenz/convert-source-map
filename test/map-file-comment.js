...
test('\nresolving a "//# sourceMappingURL=map-file-comment.css.map?foo=bar" style comment inside a given css content', function (t) {
  var css = fs.readFileSync(__dirname + '/fixtures/map-file-comment-with-query.css', 'utf8')
  var conv = convert.fromMapFileSource(css, __dirname + '/fixtures');
  var sm = conv.toObject();
